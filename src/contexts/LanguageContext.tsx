...
const translations = {
  en: {
    ...
    'puzzles.completed': 'Completed Puzzles',
      ...
      'puzzles.selectDifficulty': 'Select Puzzle Difficulty',
      'puzzles.chooseDifficulty': 'Choose your preferred difficulty level to start solving heritage puzzles',
      'puzzles.puzzles': 'puzzles',
      'guides.title': 'Local Heritage Guides',
      'guides.subtitle': 'Connect with certified heritage experts and local guides',
      'guides.contact': 'Contact Guide',
      'planner.title': 'AI Heritage Travel Planner',
      'planner.subtitle': 'Create personalized heritage tourism itineraries with AI assistance',
      'planner.planYourTrip': 'Plan Your Trip',
      'planner.destination': 'Destination',
      'planner.duration': 'Duration',
      'planner.budget': 'Budget',
      'planner.interests': 'Interests',
      'planner.groupSize': 'Group Size',
      'planner.generateItinerary': 'Generate Itinerary',
      'planner.bookNow': 'Book Now',
      'contests.title': 'Heritage Photography Contests',
      'contests.subtitle': 'Participate in photography contests and win exciting prizes',
  ...
  ta: {
    ...
    // Puzzles
    'puzzles.title': 'பாரம்பரிய புதிர்கள்',
    'puzzles.unscramble': 'இந்திய பாரம்பரிய தளங்களின் பெயர்களை சரியான வரிசையில் அமைக்கவும்',
    'puzzles.yourAnswer': 'உங்கள் பதில்',
    'puzzles.availableLetters': 'கிடைக்கும் எழுத்துக்கள்',
    'puzzles.checkAnswer': 'பதிலைச் சரிபார்க்கவும்',
    'puzzles.shuffleLetters': 'எழுத்துக்களை கலக்கவும்',
    'puzzles.reset': 'மீண்டும் தொடங்கவும்',
    'puzzles.hint': 'குறிப்பு',
    'puzzles.difficulty': 'சிரமம்',
    'puzzles.completed': 'முடிக்கப்பட்ட புதிர்கள்',
    'puzzles.leaderboard': 'லீடர்போர்ட்',
    'puzzles.selectDifficulty': 'புதிர் சிரமம் தேர்ந்தெடுக்கவும்',
    'puzzles.chooseDifficulty': 'பாரம்பரிய புதிர்களை தீர்க்க உங்கள் விருப்பமான சிரம நிலையை தேர்ந்தெடுக்கவும்',
    'puzzles.puzzles': 'புதிர்கள்',
    'guides.title': 'உள்ளூர் பாரம்பரிய வழிகாட்டிகள்',
    'guides.subtitle': 'சான்றளிக்கப்பட்ட பாரம்பரிய வல்லுநர்கள் மற்றும் உள்ளூர் வழிகாட்டிகளுடன் இணைக்கவும்',
    'guides.contact': 'வழிகாட்டியை தொடர்பு கொள்ளவும்',
    'planner.title': 'AI பாரம்பரிய பயண திட்டமிடுபவர்',
    'planner.subtitle': 'AI உதவியுடன் தனிப்பயனாக்கப்பட்ட பாரம்பரிய சுற்றுலா பயண திட்டங்களை உருவாக்கவும்',
    'planner.planYourTrip': 'உங்கள் பயணத்தை திட்டமிடுங்கள்',
    'planner.destination': 'இலக்கு',
    'planner.duration': 'கால அளவு',
    'planner.budget': 'பட்ஜெட்',
    'planner.interests': 'ஆர்வங்கள்',
    'planner.groupSize': 'குழு அளவு',
    'planner.generateItinerary': 'பயண திட்டத்தை உருவாக்கவும்',
    'planner.bookNow': 'இப்போது முன்பதிவு செய்யவும்',
    'contests.title': 'பாரம்பரிய புகைப்பட போட்டிகள்',
  }
};
